...
// Find all documents in the BirthdayBakers collection
async function getAllBakers() {
    try {
      ...
      console.error("Error retrieving bakers:", error);
      return []; // Return an empty array in case of error
    }
  }

// Call the function to retrieve all caterers and export the data
export const bakerData = await getAllBakers();
console.log("BakerData from BakersBSample.mjs: ", bakerData)
